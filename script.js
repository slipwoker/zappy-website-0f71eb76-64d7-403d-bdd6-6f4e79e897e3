    ...
    if ('IntersectionObserver' in window) {
      ...
      animatableElements.forEach(function (el, index) {
        if (!el.hasAttribute('data-delay')) {
          const siblingDelay = index % 4;
          el.setAttribute('data-delay', siblingDelay * 100);
        }
        observer.observe(el);
      });
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "טיהור בעופרת בארבעת היסודות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '0f71eb76-64d7-403d-bdd6-6f4e79e897e3',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '0f71eb76-64d7-403d-bdd6-6f4e79e897e3';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '0f71eb76-64d7-403d-bdd6-6f4e79e897e3';
